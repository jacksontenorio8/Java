...
porém temos apenas a quantidade de horas trabalhadas e o valor hora. Escreva um programa que leia o número de um
colaborador, seu número de horas trabalhadas, o valor que recebe por hora e calcula o salário desse colaborador. Em
...
public class FolhaPagamento {
    public static void main(String[] args) throws IOEception {
        ...
        double valorPorHora = leitor.nextDoule();
